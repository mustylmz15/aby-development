...
// Backend/store logic tamamen kaldırıldı. Sadece mock veri ve temel reaktif değişkenler bırakıldı.
import { ref } from 'vue';

// Tüm panellerde kullanılacak örnek/mock veri
const tableData = ref([
  {
    id: 1,
    name: 'John Doe',
  ...
  },
  {
    ...
    email: 'vincent.carpenter@yahoo.com',
    date: '13/08/2020',
    sale: 100,
    status: 'Canceled',
    register: '2 days ago',
...
// Kod gösterimi için kullanılan codeArr değişkeni (mock)
import { ref as vueRef } from 'vue';
const codeArr = vueRef<string[]>([]);
function toggleCode(code: string) {
  if (codeArr.value.includes(code)) {
    codeArr.value = codeArr.value.filter((c) => c !== code);
  } else {
    codeArr.value.push(code);
  }
}
</script>
