            ...
            <div class="bg-white dark:bg-[#0e1726] h-full">
                <div class="flex justify-between items-center px-4 py-3">
                    <router-link to="/" class="main-logo flex items-center shrink-0">
                        ...
                        <span class="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">ABY</span>
                    </router-link>
                    <a
                        href="javascript:;"
                    ...
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                        ...
                        <li class="menu nav-item">
                            <button
                                ...
                                :class="{ active: activeDropdown === 'project-operations' }"
                                @click="activeDropdown === 'project-operations' ? (activeDropdown = null) : (activeDropdown = 'project-operations')"
                            >
                                <div class="flex items-center">
                                ...
                                <div :class="{ 'rtl:rotate-90 -rotate-90': activeDropdown !== 'project-operations' }">
                                    <icon-caret-down />
                                </div>
                            </button>
                            <vue-collapsible :isOpen="activeDropdown === 'project-operations'">
                                <ul class="sub-menu text-gray-500">
                                   
                                    <li>
                                        <router-link to="/projeler" @click="toggleMobileMenu">Projeler</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/proje-detay" @click="toggleMobileMenu">Proje Detay</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/proje-raporu" @click="toggleMobileMenu">Genel Takip</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/proje-ozeti" @click="toggleMobileMenu">Proje Özeti</router-link>
                                    </li>
                                    <!-- Proje Rehberi şimdilik gizlendi istenildiği taktirde aktif hale getirilecek
                                    <li>
                                        <router-link to="/proje-rehber" @click="toggleMobileMenu">Proje Rehberi</router-link>
                                    </li>
                                    -->
                                     <li>
                                        <router-link to="/yeni-proje" @click="toggleMobileMenu">Yeni Proje</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                        </li>
                        ...
                        <li class="menu nav-item">
                            <button
                                type="button"
                                class="nav-link group w-full"
                                :class="{ active: activeDropdown === 'personnel-operations' }"
                                @click="activeDropdown === 'personnel-operations' ? (activeDropdown = null) : (activeDropdown = 'personnel-operations')"
                            >
                                <div class="flex items-center">
                                ...
                                <div :class="{ 'rtl:rotate-90 -rotate-90': activeDropdown !== 'personnel-operations' }">
                                    <icon-caret-down />
                                </div>
                            </button>
                            <vue-collapsible :isOpen="activeDropdown === 'personnel-operations'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                    ...
                                    -->
                                    <li>
                                        <router-link to="/altyuklenici-dashboard" @click="toggleMobileMenu">Alt Yüklenici Yönetimi Gösterge Paneli</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/altyuklenici-rehberi" @click="toggleMobileMenu">Altyüklenici Rehberi</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/altyuklenici-rehber-ekle" @click="toggleMobileMenu">Yeni Altyüklenici Ekle</router-link>
                                    </li>
                                    <li>
                                        <router-link to="/proje-takip-sistemi" @click="toggleMobileMenu">Proje Takip Sistemi</router-link>
                                    </li>
                                </ul>
                            </vue-collapsible>
                        </li>
                     <!--   buradaki alanlar ileride adım adım aktif hale getirilecek şimdilik yorum satırında bırakıldı
                        <h2 class="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
